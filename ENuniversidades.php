...
$dbname = "u666007820_Learnlink";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class='imagen'>
                    ...
                    <div class='texto'>
                        <a href='$linkapagina' class='boton'>More Information..</a>
                    </div>
                </div>
                ";
            }
    ...
    <!-- Divider2 -->
    <div class="acordeon-item">
		Advantages of continuing with university
    </div>
	...
	<figure class="imagenes_ventajas" style="display: flex; flex-wrap: wrap; justify-content: center; font-size: 1.5em; padding: 20px; margin-top: 20px;">
	    <div style="margin: 20px; text-align: center;">
	        ...
	        <figcaption class="ventajas_text" style="margin-top: 20px;">Prepares you for specialized areas.</figcaption>
	    </div>
	    ...
	    <div style="margin: 20px; text-align: center;">
	        ...
	        <figcaption class="ventajas_text" style="margin-top: 20px;">They provide you with economic stability.</figcaption>
	    </div>
	</figure>
    ...
    <br><br><br><br>
    <?php include("ENtest_carears.php"); ?>
