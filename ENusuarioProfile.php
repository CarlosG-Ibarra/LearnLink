                ...
                <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <?php if ($idusuarios > 0 && $idusuarios <= 4) {
                            echo '<li class="breadcrumb-item ms-auto"><a href="administracion.php">Administracion</a></li>';
                        } ?>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="ENeditProfile.php" class="btn btn-primary" style="font-size: 14px; background-color: #3FA39A;">Edit Profile</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="ENasesorias_test.php">Tutors</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $nombre; ?></li>
                        <li class="breadcrumb-item "><a href="ENasesorRegistrar.php">Register as a Tutor</a></li>
                        <li class="breadcrumb-item ms-auto"><a href="Login-Register/logout.php" onclick="logout()">Logout</a></li>
                    </ol>
                </nav>
            </div>
