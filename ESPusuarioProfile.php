            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <?php if ($idusuarios > 0 && $idusuarios <= 4) {
                            echo '<li class="breadcrumb-item ms-auto"><a href="administracion.php">Administration</a></li>';
                        } ?>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="ESPeditProfile.php" class="btn btn-primary" style="font-size: 14px; background-color: #3FA39A;">Editar Perfil</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="ESPasesorias_test.php">Asesores</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $nombre; ?></li>
                        <li class="breadcrumb-item "><a href="ESPpricing.php">Registrate como asesor</a></li>
                        <li class="breadcrumb-item ms-auto"><a href="Login-Register/logout.php" onclick="logout()">Logout</a></li>
                    </ol>
                </nav>
            </div>
