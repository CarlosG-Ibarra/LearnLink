...
<div class="px-4 pt-5 my-5 text-center border-bottom">
    <h1 class="display-4 fw-bold text-body-emphasis">Available Courses</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">Learn about the courses available in the city and the main centers that teach them.</p>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="btn-group">
                                                    <a href="'.$linkapagina.'" target="_blank" style="text-decoration: none;">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary" style="color: white; background-color: #3FA39A;"> Know the requirements</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
